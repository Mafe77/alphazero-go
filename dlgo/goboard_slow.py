...
class Board():
    ...
    def place_stone(self, player, point):
        ...
        # Remove any adj opposite color strings with 0 liberties
        for other_color_string in adjacent_opposite_color:
    ...
    def get(self, point):
        ''' Returns the content of a point in the board
            None: if empty
            Player color: if stone is there
        '''
    ...
    def get_go_string(self, point):
        ''' Return entire string of stones at that point '''
        string = self._grid.get(point)
        if string is None:
            return None
        return string
