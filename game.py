import pygame
import numpy as np
from consts import BOARD_SIZE, WINDOW_SIZE, BG_COLOR, BLACK, WHITE, WIDTH, HEIGHT, CELL_SIZE
...
def draw_board(surface, board):
    ...
    for (i,j) in star_points:
        x,y = to_screen(i,j)
        pygame.draw.circle(surface, BLACK, (x,y), max(3, int(CELL_SIZE*0.08)))
...
def draw_ui(surface, hover_pos, message):
